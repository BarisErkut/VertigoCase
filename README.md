...
## Download and Test
You can download and test the latest version (`.apk`) I compiled for Android devices from the **Releases** section on the right side of this repository. If you launch the game in Unity Editor, you can use "spacebar" to skip zones and get to any specific wheel you would like to see. I have also included the game's screenshots for different aspects (16:9, 20:9, 4:3) in the Screenshots directory within the repo.
